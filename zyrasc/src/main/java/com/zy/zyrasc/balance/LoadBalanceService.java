...
public class LoadBalanceService {
    ...
    public static ServiceClient getServiceClient(String ras, String serviceName, String url){
        ...
        //先从池中获取客户端列表
        List<ServiceClient> clients = Clients.getServicePoolMap().get(ras).getNotFusedServiceForName(serviceName, url);
     ...
     * @return 
     */
    public static ServiceClient getServiceNormalClient(String ras, String serviceName, String url){
        
        //先从池中获取客户端列表
        List<ServiceClient> clients = Clients.getServicePoolMap().get(ras).getNormalServiceForName(serviceName, url);
